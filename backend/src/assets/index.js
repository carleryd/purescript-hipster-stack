...
(function($PS) {
  ...
  var AddButton = (function () {
      function AddButton(value0) {
          this.value0 = value0;
      };
      AddButton.create = function (value0) {
          return new AddButton(value0);
      };
      return AddButton;
  })();
  var GetAmount = (function () {
      function GetAmount(value0) {
          this.value0 = value0;
      };
      GetAmount.create = function (value0) {
          return new GetAmount(value0);
      };
      return GetAmount;
  })();
  ...
  var render = function (v) {
      ...
      var element = Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
          return Click.value;
      }) ])([ Halogen_HTML_Core.text(v.label + (" " + toggleText)) ]);
      return Halogen_HTML_Elements.div_(Data_Array.replicate(v.amount)(element));
  };
      ...
      return function (v) {
          if (v instanceof AddButton) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $20.amount = state.amount + 1 | 0;
                  return $20;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("child AddButton")))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0));
                  });
              });
          };
          if (v instanceof GetAmount) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.amount;
              }))(function (amount) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value0(amount)));
              });
          };
          ...
          throw new Error("Failed pattern match at Button (line 55, column 15 - line 69, column 18): " + [ v.constructor.name ]);
      };
  };
      ...
      return function (v) {
          if (v instanceof Receive) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $31.label = v.value0.label;
                  return $31;
              });
          };
          if (v instanceof Click) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Console.log("hello")))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                      var $35 = {};
                      for (var $36 in state) {
                      ...
                      $35.toggled = !state.toggled;
                      return $35;
                  }))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.toggled;
                      }))(function (toggled) {
                          return Halogen_Query_HalogenM.raise(new Toggled(toggled));
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Button (line 30, column 16 - line 38, column 30): " + [ v.constructor.name ]);
      };
  };
...
(function($PS) {
  // Generated by purs version 0.14.1
  "use strict";
  $PS["Chapter5"] = $PS["Chapter5"] || {};
  var exports = $PS["Chapter5"];
  ...
  var IncrementButtons = (function () {
      function IncrementButtons() {

      };
      IncrementButtons.value = new IncrementButtons();
  ...
  var timer = function (dictMonadAff) {
      return function (val) {
          return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Class.liftEffect(dictMonadAff.MonadEffect0())(Halogen_Subscription.create))(function (v) {
              return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Aff_Class.liftAff(dictMonadAff)(Effect_Aff.forkAff(Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff.delay(1000.0))(function () {
  ...
  var handleAction = function (dictMonadAff) {
      return function (v) {
          ...
          if (v instanceof IncrementButtons) {
              return Halogen_Query.tell()(new Data_Symbol.IsSymbol(function () {
                  return "button";
              }))(Data_Ord.ordInt)(_button)(0)(Button.AddButton.create);
          };
          if (v instanceof HandleButton) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          throw new Error("Failed pattern match at Chapter5 (line 44, column 16 - line 56, column 14): " + [ v.constructor.name ]);
      };
  };
  var render = function (dictMonadAff) {
      return function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "button";
          }))(Data_Ord.ordInt)(_button)(0)(Button.component(dictMonadAff))({
              label: "Count: " + Data_Show.show(Data_Show.showInt)(state)
          })(HandleButton.create), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return IncrementButtons.value;
          }) ])([ Halogen_HTML_Core.text("ADD MORE!!") ]) ]);
      };
  };
  var component = function (dictMonadAff) {
      return Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Chapter5.component(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
})(PS);
PS["Main"].main();